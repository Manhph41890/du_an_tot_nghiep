                    ...
                    <div class="card">
                        ...
                        <div class="card-header justify-content-between">
                            ...
                            <div class="row">
                                ...
                                <div class="col-3">
                                    <form action="{{ route('danhgias.index') }}" method="POST" id="filter-form">
                                        @csrf
                                        @method('GET')
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-striped mb-0">
                                        ...
                                        <tbody>
                                            @foreach ($danhgias as $index => $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('danhgias.edit', $item->id) }}"><i
                                                                class="mdi mdi-pencil text-muted fs-18 rounded-2 border p-1 me-1"></i></a>
                                                        <form action="{{ route('danhgias.destroy', $item->id) }}"
