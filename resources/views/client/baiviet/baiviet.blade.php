            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-3 mb-30">
                <div class="single-blog overflow-hidden position-relative">
                    ...
                    <a class="blog-thumb mb-20 zoom-in d-block"
                        ...
                        <img src="{{ asset('/storage/' . $baiviet->anh_bai_viet) }}" class="img-fluid thumbnail"
                            alt="{{ $baiviet->tieu_de_bai_viet }}" style="height: 191px !important">
                    </a>
                    <!-- Blog Content -->
                    <div class="blog-post-content " style="height: 229px; display: flex; align-items: start; justify-content: space-between; flex-direction: column;">
