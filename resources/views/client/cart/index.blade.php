                            ...
                            <tr>
                                ...
                                <td class="text-center d-flex align-items-center gap-2">
                                    <form action="{{ route('cart.removeFromCart', $item->id) }}" method="POST"
                                        ...
                                        <button type="submit" class="btn btn-outline-danger btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Xóa">
                                        <i class="fas fa-trash"></i>
                                        </button>

                                    </form>
                                    <button type="submit" class="btn btn-outline-success btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Thanh Toán">
