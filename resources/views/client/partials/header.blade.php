...
=======
>>>>>>> 92aa5b386db27e6d8708f41f9d75e6d47e0ad734
</div>
...
<<<<<<< HEAD
    <ul class="minicart-product-list">
      <li>
        <a href="single-product.html" class="image"
          ><img src="{{asset('assets/img/mini-cart/1.png')}}" alt="Cart product Image"
        /></a>
        <div class="content">
          <a href="single-product.html" class="title"
            >orginal Age Defying Cosmetics Makeup</a
      ...
      <li>
        <a href="single-product.html" class="image"
          ><img src="{{asset('assets/img/mini-cart/2.png')}}" alt="Cart product Image"
        /></a>
        <div class="content">
          <a href="single-product.html" class="title"
            >On Trend Makeup and Beauty Cosmetics</a
      ...
      <li>
        <a href="single-product.html" class="image"
          ><img src="{{asset('assets/img/mini-cart/3.png')}}" alt="Cart product Image"
        /></a>
        <div class="content">
          <a href="single-product.html" class="title"
            >orginal Age Defying Cosmetics Makeup</a
