...
@section('content')
    <div class="content-page">
        @if ($pendingWithdrawal)
            <div class="alert alert-warning"> <strong>Chú ý!</strong> Bạn đã có một lệnh rút tiền đang chờ xác nhận. Vui lòng
                đợi lệnh hiện tại được xử lý trước khi tạo lệnh rút tiền mới. </div>
        @else
            @if ($banks)
            ...
            @else
                <div class="alert alert-warning mt-2">
                    <h5 class="alert-heading">Liên kết ngân hàng</h5>
                    <p>Bạn cần liên kết ngân hàng trước khi thực hiện rút ví.</p> <a
                        href="{{ route('shipper.createbank') }}" class="btn btn-warning">Liên kết ngân hàng</a>
                </div>
            @endif
        @endif
    </div>
