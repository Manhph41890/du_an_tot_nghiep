                ...
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-header ">
                            <div class="row">
                                <div class="col-2">
                                    <a href="<?php echo e(route('baiviets.create')); ?>" class="btn btn-success">Thêm bài viết
                                    </a>
                                </div>
                                <div class="col-3">
                                    <form action="<?php echo e(route('baiviets.index')); ?>" method="POST" id="filter-form-km">
                                        <?php echo csrf_field(); ?>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-striped mb-0">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $baiviets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $baiviet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
