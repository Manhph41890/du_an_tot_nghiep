...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="file" id="anh_danh_muc" name="anh_danh_muc  <?php $__errorArgs = ['anh_danh_muc'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                                            ...
                                            <div class="col-sm-10 mb-3 d-flex gap-2">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="trang_thai"
                                                        value="<?php echo e(old('is_active')); ?>" id="trang_thai_hide" value="1">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\datn\du_an_tot_nghiep\resources\views/admin/danhmuc/create.blade.php ENDPATH**/ ?>